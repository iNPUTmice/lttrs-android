...
public class AutocryptSetupMessage {
    ...
    private AutocryptSetupMessage(AccountWithCredentials account, String message, PassphraseHint passphraseHint) {
        this.account = account;
        this.message = message;
        this.passphraseHint = passphraseHint;
    }

    public static AutocryptSetupMessage of(final AccountWithCredentials account, final String message) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(account, that.account) && Objects.equal(message, that.message) && Objects.equal(passphraseHint, that.passphraseHint);
    }
